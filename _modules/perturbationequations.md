...
Clone the repository, add it to your Mathematica ``$Path``, and load it with ``Needs``. See the [repository README](https://github.com/BlackHolePerturbationToolkit/PerturbationEquations) for details.
