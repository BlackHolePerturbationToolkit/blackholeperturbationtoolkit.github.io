...
**Stub page.** Full documentation for RegularizationParameters is in progress. For now, see the [source repository](https://github.com/BlackHolePerturbationToolkit/RegularizationParameters).
</div>
...
The data lives in the [repository](https://github.com/BlackHolePerturbationToolkit/RegularizationParameters).
...
See the [repository](https://github.com/BlackHolePerturbationToolkit/RegularizationParameters) for examples.
